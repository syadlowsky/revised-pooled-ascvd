...
cat("\nTable Expected versus observed\n")
print(concat.expected_over_observed_table(
    expected_over_observed_table(
        baseline.results, model.name="Model set 1: Cox model 4 equations"),
    expected_over_observed_table(
        logistic.4.eq.results, model.name="Model set 2: Logistic model 4 equations"),
    expected_over_observed_table(
        logistic.2.eq.results, model.name="Model set 3: Logistic model 2 equations")))
